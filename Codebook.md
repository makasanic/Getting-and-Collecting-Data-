...
Original Data
The original data comes from the http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
 
 The variables in the tidy data
 Tidy data contains 180 rows and 68 columns.
 Each row has averaged variables for each subject and each activity.
 
 Only all the variables estimated for Mean and Standard deviation in the tidyse were kept.
 1.mean():mean value
 2.std(): Standard deviation
 
 The data were averaged based on subject and activity group.
 Subject columns has 6 types as listed below.
 1.WALKING
 2.WALKING_UPSTAIRS
